...
The features H5 (produced by ``experiments.E2.compute_features``) is consumed
...
from experiments.E2._lib.probes.mlp import fit_mlp_probe
from experiments.E2._lib.stats.bootstrap import patient_level_bootstrap_r2
from experiments.E2.E2_1_recoverability.analysis.plotting import (

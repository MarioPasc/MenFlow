...
def patient_level_bootstrap_r2(
    ...
    *,
    ...
    fit_fn
        ...
        :mod:`experiments.E2._lib.probes.linear` is wrapped externally to match this.
    n_boot
...
def bootstrap_directions(
    ...
    *,
    ...
    :func:`~experiments.E2._lib.probes.linear.fit_linear_probe`, normalizes the
    ...
    seed:
        RNG seed for reproducibility.
    alphas:
        Regularization grid passed to :func:`~experiments.E2._lib.probes.linear.fit_linear_probe`.

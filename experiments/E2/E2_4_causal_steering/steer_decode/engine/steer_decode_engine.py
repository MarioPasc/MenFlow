...
2. Read the source segmentation, isolate the tumor labels, replicate the
   ...
   resolution via :func:`experiments.E2._lib.latent_features.mask.project_mask_to_latent`
   (stride 4 max-pool). Optionally dilate by ``mask_dilation_radius``.
3. Compute the steered latent via
   :func:`experiments.E2._lib.steering.operator.local_steer` (or ``global_steer``):
...
:func:`experiments.E2.E2_4_causal_steering.analysis.segmenter_interface.fill_sweep_results`.
...
from experiments.E2._lib.steering.anchors import StratifiedAnchor, stratified_anchor_indices
from experiments.E2._lib.steering.calibration import delta_to_alpha
from experiments.E2._lib.steering.drift import off_manifold_drift
from experiments.E2._lib.steering.mask_dilation import dilate_mask_lat
from experiments.E2._lib.steering.operator import STEER_OPERATORS

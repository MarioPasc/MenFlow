#!/bin/bash
# experiments/E1_pathology_preservation/slurm/launcher_full.sh
# --------------------------------------------------------------------------
# Submit the full E1 pipeline: encode -> decode -> analysis, with afterok
# dependencies between consecutive steps.
#
# Usage:
#   bash experiments/E1_pathology_preservation/slurm/launcher_full.sh \
#        <encoder_config.yaml> <decoder_config.yaml> <analysis_config.yaml>
#   bash experiments/E1_pathology_preservation/slurm/launcher_full.sh --dry-run \
#        <encoder_config.yaml> <decoder_config.yaml> <analysis_config.yaml>
#

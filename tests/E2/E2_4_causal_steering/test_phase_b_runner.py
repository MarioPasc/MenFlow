...
from experiments.E2.E2_4_causal_steering.analysis.phase_b_runner import (
    ALL_MODALITIES,
...
def test_phase_b_fills_h5_and_writes_artifacts(tmp_path: Path):
    ...
    with (
        patch(
            "experiments.E2.E2_4_causal_steering.analysis.phase_b_runner.decode_companion_modalities",
            side_effect=_fake_decode_companions,
        ),
        patch(
            "experiments.E2.E2_4_causal_steering.analysis.phase_b_runner.BratsDockerSegmenter",
            _FakeSegmenter,
        ),
    ):
